...
export function FactoryResourceSelection() {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 text-gray-900">
        <div className="bg-white p-6 rounded shadow-lg text-center">
          <h2 className="text-xl font-bold mb-4 text-gray-900">Assign a Resource to the Factory</h2>
          <p className="mb-2 text-gray-900">Choose one resource. When it's drawn later, you can override it.</p>
  ...
  if (showFactoryAssignPopup && pendingFactoryOverride) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 text-gray-900">
        <div className="bg-white p-6 rounded shadow-lg text-center">
          <h2 className="text-xl font-bold mb-4 text-gray-900">Factory Resource Substitution</h2>
          <p className="mb-2 text-gray-900">You drew {pendingFactoryOverride}. Choose any resource to place instead:</p>
          <div className="grid grid-cols-3 gap-2">
            {allResources.map(res => (
              <button
                key={res}
